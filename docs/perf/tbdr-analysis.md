...
blending, or explicit load/store actions. Wildhaven can only present patterns
...
HSR claim because Wildhaven's former "opaque" list also contained alpha-tested
