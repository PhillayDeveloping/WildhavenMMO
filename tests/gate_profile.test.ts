...
describe('extractFileDurations and rankSlowestFiles', () => {
  const sampleReport = {
    testResults: [
      {
        name: '/Users/dev/wildhaven/tests/sim.test.ts',
        startTime: 1000,
        endTime: 5000,
      },
      {
        name: '/Users/dev/wildhaven/tests/architecture.test.ts',
        duration: 9000,
      },
      {
      ...
      },
      {
        ...
        name: '/Users/dev/wildhaven/tests/empty.test.ts',
      },
      {
        name: '/Users/dev/wildhaven/tests/fast.test.ts',
        durationMs: 50,
      },
    ],
  };
