...
describe('characterSheet: shared fields', () => {
  it('derives classLabel, zone, virtualLevel, prestige, spec, avatar + profile urls', () => {
    ...
    expect(sheet.realm).toBe('Wildmoon');
    ...
    expect(sheet.avatarUrl).toBe('https://wildhaven.example/avatar/shaman/0.png');
    expect(sheet.profileUrl).toBe('https://wildhaven.example/c/Thrallish');
