...
//
// Mirrors the shape pins tests/dev_tier.test.ts gives the contributor ladder art
// (upstream's twin for the $WOC holder ladder, which this web3-free fork does not
// ship), because the sigil ships through the same three contracts: it is a self-contained
