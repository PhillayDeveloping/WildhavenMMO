...
`claudium/gallery.html`), is world-readable at wildhaven.example. Keep all of it
...
## The standalone HTML pages: two kinds
...
(Upstream has a third kind, the machine/redirect pages behind the mobile wallet
round-trip. This fork ships no wallet, so it has none.)
