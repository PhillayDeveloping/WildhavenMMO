...
# overlay trees and the Russian doc mirrors (native punctuation such as a real em dash
# is legitimate there: Russian and French prose use it correctly; keep this set
# identical to the copy-scan exclusions in .githooks/pre-push) and the generated
# bundles. The admin overlays were missing from this list while their generated twin
# was excluded, so editing an admin translation could block on punctuation the rule
