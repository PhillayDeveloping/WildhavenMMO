...
description: >
  ...
  presentation code in Wildhaven. Audits a diff for COVERAGE of the frontend
...
You are the presentation-seam reviewer for the frontend of Wildhaven. The HUD is
