...
const DEFAULT_PRODUCTION_PUBLIC_ORIGIN = 'https://wildhaven.example';
const TRUSTED_PUBLIC_HOST_ORIGINS = new Map([
  ['wildhaven.example', DEFAULT_PRODUCTION_PUBLIC_ORIGIN],
  ['www.wildhaven.example', DEFAULT_PRODUCTION_PUBLIC_ORIGIN],
  ['dev.wildhaven.example', 'https://dev.wildhaven.example'],
]);
...
export const PUBLIC_CARD_COPY: Record<PublicCardLocale, PublicCardCopy> = {
  en: {
    ...
    description: '{name} is forging a legend in Wildhaven. Join the realm.',
  ...
  es: {
    ...
    description: '{name} está forjando una leyenda en Wildhaven. Únete al reino.',
    ...
    missingCta: 'Entrar en Wildhaven',
    classes: {
      warrior: 'Guerrero',
      paladin: 'Paladín',
      hunter: 'Cazador',
  ...
  fr_FR: {
    ...
    description: '{name} forge sa légende dans Wildhaven. Rejoignez le royaume.',
    ...
    missingCta: 'Entrer dans Wildhaven',
    classes: {
      warrior: 'Guerrier',
      paladin: 'Paladin',
      hunter: 'Chasseur',
  ...
  it_IT: {
    ...
    description: '{name} sta forgiando una leggenda in Wildhaven. Entra nel reame.',
  ...
  de_DE: {
    ...
    description: '{name} schmiedet eine Legende in Wildhaven. Betretet das Reich.',
  ...
  zh_CN: {
    ...
    description: '{name} 正在 Wildhaven 中铸就传奇。加入这个国度。',
    cta: '铸就你的传奇',
    missingTitle: '未找到卡片',
    missingHeading: '这张卡片已不可用。',
    missingDescription: '它可能已被撤下，或从未存在。',
    missingCta: '进入 Wildhaven',
    classes: {
      warrior: '战士',
      paladin: '圣骑士',
      hunter: '猎人',
  ...
  zh_TW: {
    ...
    description: '{name} 正在 Wildhaven 中鑄就傳奇。加入這個國度。',
    cta: '鑄就你的傳奇',
    missingTitle: '找不到卡片',
    missingHeading: '這張卡片已不可用。',
    missingDescription: '它可能已被移除，或從未存在。',
    missingCta: '進入 Wildhaven',
    classes: {
      warrior: '戰士',
      paladin: '聖騎士',
      hunter: '獵人',
  ...
  pt_BR: {
    ...
    description: '{name} está forjando uma lenda em Wildhaven. Entre no reino.',
    cta: 'Forje sua lenda',
    ...
    missingCta: 'Entrar em Wildhaven',
    classes: {
      warrior: 'Guerreiro',
      paladin: 'Paladino',
      hunter: 'Caçador',
  ...
  ru_RU: {
    ...
    description: '{name} создает легенду в Wildhaven. Присоединяйтесь к миру.',
