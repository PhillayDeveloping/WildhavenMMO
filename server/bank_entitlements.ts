...
// bag of account facts (email verified, Discord linked, qualified referrals)
// into the bonus-slot total plus the per-source breakdown the bank
...
/** The shipped registry: +2 email (verified), +2 Discord, +2 per qualified
