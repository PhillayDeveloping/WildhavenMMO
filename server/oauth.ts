...
<title>Authorize ${escapeHtml(o.client)} · Wildhaven</title><meta name="robots" content="noindex">${PAGE_STYLE}</head>
<body><main>
  ...
  <p style="font-size:13px;color:#7c6f4e">Signed in via your Wildhaven web session.</p>
</main>
<script>
  var REQ = ${data};
  ...
  document.getElementById('allow').onclick=function(){
    var t=token();
    if(!t){ document.getElementById('msg').textContent='Please log in to Wildhaven first, then reopen this link.'; return; }
...
<meta name="viewport" content="width=device-width, initial-scale=1">
<title>Link a device · Wildhaven</title><meta name="robots" content="noindex">${PAGE_STYLE}</head>
<body><main>
  <h1>Link a device</h1>
...
<script>
  ...
  document.getElementById('ok').onclick=function(){
    var t=token(); if(!t){ document.getElementById('msg').textContent='Please log in to Wildhaven first.'; return; }
