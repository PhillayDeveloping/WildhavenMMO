...
export const zh_CN: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "wiki": {
      "confirmTitle": "打开维基？",
      "confirmBody": "将在浏览器中打开 Wildhaven 维基，游戏会继续运行。",
      "confirmOpen": "打开维基",
      "confirmCancel": "取消"
    },
    "unstuck": {
    ...
    "dailyRewards": {
      ...
      "disclaimer": "任务与排行榜每日重置一次。前十名瓜分奖金池，你的那一份将由渡鸦在你下次登录时送达。",
      "prize": "奖池",
      "reset": "重置",
      "endsIn": "{time}后结束",
    ...
    "nativeUpdate": {
      "title": "有可用更新",
      "body": "Wildhaven 有新版本可用。立即更新以获取最新修复和改进。",
      "bodyWithVersion": "Wildhaven {version} 版本已可用。立即更新以获取最新修复和改进。",
      "notNow": "暂不",
      "update": "更新"
    },
    "cameraPrompt": {
    ...
    "perf": {
      ...
      "diagnostics": {
        "panelAria": "Wildhaven 性能诊断",
        "title": "Wildhaven 性能医生",
  ...
  "guide": {
    ...
    "worldPage": {
      "heading": "世界",
      "intro": "Wildhaven 是一片你要靠双脚走遍的连续大陆。古道自南向北穿过起始山谷、沼泽和山峰，并越过它们继续攀升，通向其后的洼地以及地图顶端的雪境。自那条路向西展开一列更高等级的国度，向东另有一列，谷地东岸外还有一座岛屿。这里没有快速旅行，没有飞行路线，也没有马车：每一段路程都靠步行或骑乘完成，所以抵达本身就是冒险的一部分。\n\n这片大地也记录着时间。昼夜循环依照一只你所在世界人人共享的真实时钟运转，因此天空会为你们所有人同时从黎明经正午走向黄昏与夜色，月亮循着盈亏来去，地面上的光影也随之变化。小地图周围的表盘，就是你读取时辰的地方。",
      "hub": "大本营",
  ...
  "playerCard": {
    ...
    "arenaStat": "竞技场",
    "shareText": "我正在 Wildhaven 中铸就传说：{level}级 {className}{tierBit}。加入我的世界：",
  ...
  "seo": {
    ...
    "description": "在 Wildhaven 展开史诗冒险。这是一款可直接在浏览器中游玩的经典风格微型 MMO。加入持续共享的世界，提升职业等级，击败敌人！",
    "genre": "MMORPG",
    "playMode": "多人游戏",
  ...
  "desktop": {
    ...
    "crash": {
      ...
      "reload": "重新加载",
      "quit": "退出",
      "fatalBody": "Wildhaven 遇到意外错误，需要关闭。"
    }
  },
  "gpuNotice": {
  ...
  "entities": {
    ...
    "letters": {
      ...
      "daily_reward_prize": {
        "sender": "山谷总管",
        "subject": "你的每日奖金份额",
        "body": "山谷记得谁在其中最为勤勉，而昨日你的名字位列最高的十人之中。总管们已称量出你应得的那份每日奖金，并托渡鸦送来。\n\n明日再来，若你能够，便夺下头名。\n\n- 山谷总管"
      },
