...
export const ja_JP: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "wiki": {
      ...
      "confirmBody": "Wildhaven のWikiをブラウザで開きます。ゲームはそのまま続行されます。",
      "confirmOpen": "Wikiを開く",
      "confirmCancel": "キャンセル"
    },
    "unstuck": {
    ...
    "perf": {
      ...
      "diagnostics": {
        "panelAria": "Wildhaven パフォーマンス診断",
        "title": "Wildhaven パフォーマンス診断",
  ...
  "guide": {
    ...
    "worldPage": {
      "heading": "世界",
      "intro": "Wildhavenは、徒歩で渡っていく、ひと続きの大地です。古い街道は南から北へ、始まりの谷、湿地、山嶺を貫き、その先の窪地と地図の北端の雪国へと登り続けます。その街道からは西へ高位の領邦がひと連なり、東にもうひと連なり開けており、ヴェイルの東岸沖には島が浮かんでいます。高速移動はなく、飛行路も馬車もありません。どの道のりも歩くか騎乗するかで進むので、たどり着くことそのものが冒険の一部です。\n\n大地は時も刻みます。昼夜の周期は、あなたのワールドにいる全員が共有する実際の時計で進むので、空は皆にとって同時に夜明けから正午、そして黄昏と闇へと移り変わり、月は満ち欠けを巡り、地上の光もそれにつれて変わります。ミニマップを囲む文字盤が、時刻を読み取る場所です。",
      "hub": "拠点",
