...
export const ko_KR: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "wiki": {
      ...
      "confirmBody": "Wildhaven 위키를 브라우저에서 엽니다. 게임은 계속 실행됩니다.",
      "confirmOpen": "위키 열기",
      "confirmCancel": "취소"
    },
    "unstuck": {
    ...
    "perf": {
      ...
      "diagnostics": {
        "panelAria": "Wildhaven 성능 진단",
        "title": "Wildhaven 성능 진단",
    ...
    "discord": {
      ...
      "swag": {
        ...
        "titleChampion": "칭호: Wildmoon의 챔피언",
  ...
  "guide": {
    ...
    "worldPage": {
      "heading": "세계",
      "intro": "Wildhaven는 당신이 두 발로 가로지르는 하나로 이어진 땅입니다. 옛 길은 남쪽에서 북쪽으로 시작의 골짜기와 늪지와 봉우리를 꿰뚫고, 그것들을 지나 그 너머의 분지와 지도 꼭대기의 눈의 땅까지 계속 올라갑니다. 그 길에서 서쪽으로 더 높은 왕국들이 한 줄, 동쪽으로 또 한 줄 열리고, 밸리의 동쪽 해안 앞바다에는 섬이 하나 놓여 있습니다. 빠른 이동도, 비행 경로도, 마차도 없습니다. 모든 여정은 걷거나 타고 가는 것이므로, 다다르는 일 자체가 모험의 일부입니다.\n\n이 땅은 시간도 셉니다. 낮과 밤의 순환은 당신의 세계에 있는 모두가 함께 쓰는 실제 시계로 돌아가므로, 하늘은 여러분 모두에게 동시에 새벽에서 한낮을 지나 황혼과 어둠으로 옮겨가고, 달은 차고 기울며 오가고, 땅 위의 빛도 그에 따라 바뀝니다. 미니맵을 두른 눈금판이 시각을 읽는 곳입니다.",
      "hub": "본거지",
  ...
  "seo": {
    ...
    "officialBody": "wildhaven.example은 Wildmoon 월드의 공식 무료 브라우저 MMO입니다. 지속 캐릭터로 온라인 플레이를 하거나, 오프라인에서 혼자 탐험하고, 위키를 읽고, 이 사이트에서 검증된 커뮤니티 링크를 확인하세요."
  },
  "a11y": {
    "goHome": "홈으로 이동",
    "toggleMenu": "메뉴 전환",
