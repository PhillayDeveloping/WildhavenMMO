...
export const fr_FR: EnTranslations = {
  ...
  "seo": {
    ...
    "description": "Partez pour une aventure épique dans Wildhaven, un micro-MMO au style classique jouable directement dans votre navigateur. Rejoignez un monde persistant, progressez en classe et terrassez vos ennemis.",
    "genre": "MMORPG",
