...
export const zh_TW: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "wiki": {
      "confirmTitle": "開啟維基？",
      "confirmBody": "將在瀏覽器中開啟 Wildhaven 維基，遊戲會繼續執行。",
      "confirmOpen": "開啟維基",
      "confirmCancel": "取消"
    },
    "unstuck": {
    ...
    "perf": {
      ...
      "diagnostics": {
        "panelAria": "Wildhaven 效能診斷",
        "title": "Wildhaven 效能醫生",
  ...
  "guide": {
    ...
    "worldPage": {
      "heading": "世界",
      "intro": "Wildhaven 是一片你要靠雙腳走遍的連續大陸。古道自南向北穿過起始山谷、沼澤和山峰，並越過它們繼續攀升，通向其後的窪地以及地圖頂端的雪境。自那條路向西展開一列更高等級的國度，向東另有一列，谷地東岸外還有一座島嶼。這裡沒有快速旅行，沒有飛行路線，也沒有馬車：每一段路程都靠步行或騎乘完成，所以抵達本身就是冒險的一部分。\n\n這片大地也記錄著時間。晝夜循環依照一只你所在世界人人共享的真實時鐘運轉，因此天空會為你們所有人同時從黎明經正午走向黃昏與夜色，月亮循著盈虧來去，地面上的光影也隨之變化。小地圖周圍的錶盤，就是你讀取時辰的地方。",
      "hub": "主據點",
  ...
  "seo": {
    ...
    "officialBody": "wildhaven.example 是 Wildmoon 世界的官方免費瀏覽器 MMO。你可以用持久角色線上遊玩，也可以離線單人探索、閱讀 wiki，並從本站前往已驗證的社群連結。"
  },
  "a11y": {
    "goHome": "前往首頁",
    "toggleMenu": "切換選單",
