...
> = {
  ...
  cs_CZ: {
    ...
    dru_r5_ferocity: 'Změna podoby udělí 60 % rychlosti pohybu na 3 s, nejvýše jednou za 20 s.',
  ...
  vi_VN: {
    ...
    dru_r5_ferocity: 'Biến hình ban 60% tốc độ di chuyển trong 3 giây, tối đa một lần mỗi 20 giây.',
  ...
  zh_CN: {
    ...
    dru_r5_ferocity: '变形使移动速度提高 60%，持续 3 秒，每 20 秒最多触发一次。',
  ...
  zh_TW: {
    ...
    dru_r5_ferocity: '變形會給予 60% 移動速度，持續 3 秒，每 20 秒最多觸發一次。',
  ...
  ja_JP: {
    ...
    dru_r5_ferocity: '変身すると、3秒間移動速度が60%上昇する。発動は最短でも20秒に1回まで。',
  ...
  ko_KR: {
    ...
    dru_r5_ferocity: '변신하면 3초 동안 이동 속도가 60% 증가하며, 20초에 한 번만 발동합니다.',
