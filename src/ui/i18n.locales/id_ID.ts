...
export const id_ID: Partial<Record<TranslationKey, string>> = {
  ...
  'seo.genre': 'MMORPG',
  'seo.officialBody':
    'wildhaven.example adalah MMO peramban gratis resmi untuk dunia Wildmoon. Bermain daring dengan karakter yang persisten, jelajahi solo secara luring, baca wiki, dan ikuti tautan komunitas terverifikasi dari situs ini.',
  ...
  'serverUnavailable.body':
    'Kami sedang memulai ulang layanan game dan memperkirakan Wildmoon akan kembali sebentar lagi. Halaman ini akan terus memeriksa secara otomatis.',
  ...
  'hudChrome.discord.swag.titleChampion': 'Gelar: Jawara Wildmoon',
