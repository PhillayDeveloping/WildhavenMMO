...
export const sv_SE: Partial<Record<TranslationKey, string>> = {
  ...
  'seo.genre': 'MMORPG',
  'seo.officialBody':
    'wildhaven.example är den officiella gratis webbläsar-MMO:n för Wildmoon-världen. Spela online med en beständig karaktär, utforska solo offline, läs wikin och följ verifierade gemenskapslänkar från den här webbplatsen.',
  ...
  'serverUnavailable.body':
    'Vi startar om speltjänsten och förväntar oss att Wildmoon är tillbaka inom kort. Den här sidan fortsätter att kontrollera automatiskt.',
  ...
  'hudChrome.discord.swag.titleChampion': 'Titel: Champion of Wildmoon',
