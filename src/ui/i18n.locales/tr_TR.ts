...
export const tr_TR: Partial<Record<TranslationKey, string>> = {
  ...
  'seo.genre': 'MMORPG',
  'seo.officialBody':
    "wildhaven.example, Wildmoon dünyasının resmi ücretsiz tarayıcı MMO'sudur. Kalıcı bir karakterle çevrimiçi oyna, çevrimdışı tek başına keşfet, wiki'yi oku ve bu siteden doğrulanmış topluluk bağlantılarını takip et.",
  ...
  'serverUnavailable.body':
    "Oyun hizmetini yeniden başlatıyoruz ve Wildmoon'un kısa süre içinde geri döneceğini umuyoruz. Bu sayfa otomatik olarak denetlemeye devam edecek.",
  ...
  'hudChrome.discord.swag.titleChampion': 'Unvan: Wildmoon Şampiyonu',
