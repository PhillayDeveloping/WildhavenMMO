...
export const ko_KR: Partial<Record<TranslationKey, string>> = {
  ...
  'seo.officialLabel': 'Wildhaven 공식 웹사이트',
  'seo.officialBody':
    'wildhaven.example은 Wildmoon 월드의 공식 무료 브라우저 MMO입니다. 지속 캐릭터로 온라인 플레이를 하거나, 오프라인에서 혼자 탐험하고, 위키를 읽고, 이 사이트에서 검증된 커뮤니티 링크를 확인하세요.',
  ...
  'playerCard.shareText':
    'Wildhaven에서 제 전설을 벼리고 있습니다: {level}레벨 {className}{tierBit}. 제 월드에 합류하세요:',
  ...
  'seo.title': 'Wildhaven: 클래식 스타일 웹 MMO',
  'seo.description':
    '브라우저에서 바로 즐기는 클래식 스타일 마이크로 MMO, Wildhaven에서 장대한 모험을 시작하세요. 지속되는 공유 월드에 접속해 직업을 성장시키고 적을 물리치세요.',
  'seo.genre': 'MMORPG',
  'seo.playMode': '멀티플레이어',
  ...
  'a11y.githubProject': 'GitHub에서 Wildhaven 프로젝트 열기',
  'a11y.discordCommunity': 'Wildhaven Discord 커뮤니티 참여',
  'a11y.donateProject': 'Wildhaven 후원하기',
  'entryGuard.body':
  ...
  'mobilePreflight.iosOpenStep': '새 홈 화면 아이콘에서 Wildhaven를 여세요.',
  ...
  'mobilePreflight.androidOpenStep': '새 아이콘에서 Wildhaven를 여세요.',
  ...
  'guide.worldPage.intro': 'Wildhaven는 당신이 두 발로 가로지르는 하나로 이어진 땅입니다. 옛 길은 남쪽에서 북쪽으로 시작의 골짜기와 늪지와 봉우리를 꿰뚫고, 그것들을 지나 그 너머의 분지와 지도 꼭대기의 눈의 땅까지 계속 올라갑니다. 그 길에서 서쪽으로 더 높은 왕국들이 한 줄, 동쪽으로 또 한 줄 열리고, 밸리의 동쪽 해안 앞바다에는 섬이 하나 놓여 있습니다. 빠른 이동도, 비행 경로도, 마차도 없습니다. 모든 여정은 걷거나 타고 가는 것이므로, 다다르는 일 자체가 모험의 일부입니다.\n\n이 땅은 시간도 셉니다. 낮과 밤의 순환은 당신의 세계에 있는 모두가 함께 쓰는 실제 시계로 돌아가므로, 하늘은 여러분 모두에게 동시에 새벽에서 한낮을 지나 황혼과 어둠으로 옮겨가고, 달은 차고 기울며 오가고, 땅 위의 빛도 그에 따라 바뀝니다. 미니맵을 두른 눈금판이 시각을 읽는 곳입니다.',
  ...
  'hudChrome.discord.swag.titleChampion': '칭호: Wildmoon의 챔피언',
  ...
  'hudChrome.nativeUpdate.body':
    'Wildhaven의 새 버전을 사용할 수 있습니다. 지금 업데이트하여 최신 수정 사항과 개선 사항을 받으세요.',
  'hudChrome.nativeUpdate.bodyWithVersion':
    'Wildhaven 버전 {version}을(를) 사용할 수 있습니다. 지금 업데이트하여 최신 수정 사항과 개선 사항을 받으세요.',
  ...
  'desktop.crash.fatalBody': 'Wildhaven에 예기치 않은 오류가 발생하여 종료해야 합니다.',
  ...
  'editor.docTitle': '맵 편집기 - Wildhaven',
  ...
  'hudChrome.wiki.confirmBody':
    'Wildhaven 위키를 브라우저에서 엽니다. 게임은 계속 실행됩니다.',
  ...
  'hudChrome.perf.diagnostics.panelAria': 'Wildhaven 성능 진단',
  'hudChrome.perf.diagnostics.title': 'Wildhaven 성능 진단',
  ...
  'hudChrome.perf.diagnostics.report.title': 'Wildhaven 성능 진단',
