...
export const zh_CN: Partial<Record<TranslationKey, string>> = {
  ...
  'seo.officialLabel': 'Wildhaven 官方网站',
  'seo.officialBody':
    'wildhaven.example 是 Wildmoon 世界的官方免费浏览器 MMO。你可以用持久角色在线游玩，也可以离线单人探索，阅读 wiki，并从本站访问已验证的社区链接。',
  ...
  'playerCard.shareText':
    '我正在 Wildhaven 中铸就传说：{level}级 {className}{tierBit}。加入我的世界：',
  ...
  'controls.chat': '打开聊天框',
  'seo.title': 'Wildhaven：经典风格网页 MMO',
  'seo.description':
    '在 Wildhaven 展开史诗冒险。这是一款可直接在浏览器中游玩的经典风格微型 MMO。加入持续共享的世界，提升职业等级，击败敌人！',
  'seo.genre': 'MMORPG',
  'seo.playMode': '多人游戏',
  ...
  'a11y.githubProject': '打开 Wildhaven 的 GitHub 项目',
  'a11y.discordCommunity': '加入 Wildhaven 的 Discord 社区',
  'a11y.donateProject': '捐赠支持 Wildhaven',
  'entryGuard.body':
  ...
  'mobilePreflight.iosOpenStep': '从新的主屏幕图标打开 Wildhaven。',
  ...
  'guide.worldPage.intro': 'Wildhaven 是一片你要靠双脚走遍的连续大陆。古道自南向北穿过起始山谷、沼泽和山峰，并越过它们继续攀升，通向其后的洼地以及地图顶端的雪境。自那条路向西展开一列更高等级的国度，向东另有一列，谷地东岸外还有一座岛屿。这里没有快速旅行，没有飞行路线，也没有马车：每一段路程都靠步行或骑乘完成，所以抵达本身就是冒险的一部分。\n\n这片大地也记录着时间。昼夜循环依照一只你所在世界人人共享的真实时钟运转，因此天空会为你们所有人同时从黎明经正午走向黄昏与夜色，月亮循着盈亏来去，地面上的光影也随之变化。小地图周围的表盘，就是你读取时辰的地方。',
  ...
  'hudChrome.discord.swag.titleChampion': '称号：Wildmoon 勇士',
  ...
  'hudChrome.nativeUpdate.body': 'Wildhaven 有新版本可用。立即更新以获取最新修复和改进。',
  'hudChrome.nativeUpdate.bodyWithVersion':
    'Wildhaven {version} 版本已可用。立即更新以获取最新修复和改进。',
  ...
  'desktop.crash.fatalBody': 'Wildhaven 遇到意外错误，需要关闭。',
  ...
  'editor.docTitle': '地图编辑器 - Wildhaven',
  ...
  'hudChrome.wiki.confirmBody': '将在浏览器中打开 Wildhaven 维基，游戏会继续运行。',
  ...
  'hudChrome.dailyRewards.disclaimer':
    '任务与排行榜每日重置一次。前十名瓜分奖金池，你的那一份将由渡鸦在你下次登录时送达。',
  ...
  'entities.letters.daily_reward_prize.body':
    '山谷记得谁在其中最为勤勉，而昨日你的名字位列最高的十人之中。总管们已称量出你应得的那份每日奖金，并托渡鸦送来。\n\n明日再来，若你能够，便夺下头名。\n\n- 山谷总管',
  ...
  'hudChrome.perf.diagnostics.panelAria': 'Wildhaven 性能诊断',
  'hudChrome.perf.diagnostics.title': 'Wildhaven 性能医生',
  ...
  'hudChrome.perf.diagnostics.report.title': 'Wildhaven 性能诊断',
