...
export const vi_VN: Partial<Record<TranslationKey, string>> = {
  ...
  'editor.docTitle': 'Trình Chỉnh Sửa Bản Đồ - Wildhaven',
  ...
  'a11y.discordCommunity': 'Tham gia cộng đồng Discord của Wildhaven',
  'a11y.donateProject': 'Quyên góp ủng hộ Wildhaven',
  'a11y.githubProject': 'Mở dự án GitHub của Wildhaven',
  ...
  'guide.worldPage.intro':
    'Wildhaven là một vùng đất liền mạch mà bạn băng qua bằng đôi chân, ba khu vực trải dài từ nam tới bắc. Không có di chuyển nhanh, nên hành trình là một phần của cuộc phiêu lưu.',
  ...
  'mobilePreflight.androidOpenStep': 'Mở Wildhaven từ biểu tượng mới.',
  ...
  'mobilePreflight.iosOpenStep': 'Mở Wildhaven từ biểu tượng mới trên Màn hình chính.',
  ...
  'playerCard.shareText':
    'Tôi đang rèn nên huyền thoại của mình trong Wildhaven: {className} cấp {level}{tierBit}. Hãy tham gia thế giới của tôi:',
  ...
  'seo.description':
    'Bắt đầu cuộc phiêu lưu hoành tráng trong Wildhaven, một micro-MMO phong cách cổ điển chơi trực tiếp trên trình duyệt của bạn. Tham gia một thế giới chung bền vững, lên cấp các lớp nhân vật và đánh bại kẻ thù!',
  'seo.genre': 'MMORPG',
  'seo.officialBody':
    'wildhaven.example là trang MMO trên trình duyệt miễn phí chính thức cho thế giới Wildmoon. Chơi trực tuyến với một nhân vật bền vững, khám phá đơn lẻ ngoại tuyến, đọc wiki và theo dõi các liên kết cộng đồng đã được xác minh từ trang này.',
  'seo.officialLabel': 'Trang web Wildhaven chính thức',
  'seo.operatingSystem': 'Trình duyệt web',
  'seo.playMode': 'Nhiều người chơi',
  'seo.title': 'Wildhaven: MMO Web Phong Cách Cổ Điển',
  'serverUnavailable.body':
    'Chúng tôi đang khởi động lại dịch vụ trò chơi và dự kiến Wildmoon sẽ trở lại trong giây lát. Trang này sẽ tự động tiếp tục kiểm tra.',
  ...
  'serverUnavailable.title': 'Wildhaven - Thế Giới Không Khả Dụng',
  ...
  'hudChrome.discord.swag.titleChampion': 'Danh Hiệu: Nhà Vô Địch Wildmoon',
  ...
  'desktop.crash.fatalBody': 'Wildhaven gặp lỗi không mong muốn và cần đóng lại.',
  ...
  'hudChrome.nativeUpdate.bodyWithVersion':
    'Đã có phiên bản {version} của Wildhaven. Cập nhật ngay để nhận các bản sửa lỗi và cải tiến mới nhất.',
