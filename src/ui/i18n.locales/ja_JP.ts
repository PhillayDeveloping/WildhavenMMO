...
export const ja_JP: Partial<Record<TranslationKey, string>> = {
  ...
  'seo.officialLabel': 'Wildhaven 公式サイト',
  'seo.officialBody':
    'wildhaven.example は Wildmoon ワールドの公式無料ブラウザMMOです。永続キャラクターでオンラインプレイし、オフラインでソロ探索し、wikiを読み、このサイトから確認済みのコミュニティリンクをたどれます。',
  ...
  'playerCard.shareText':
    'Wildhavenで伝説を鍛えています: レベル{level} {className}{tierBit}。私のワールドに参加してください:',
  ...
  'seo.title': 'Wildhaven: クラシック風Web MMO',
  'seo.description':
    'ブラウザで直接遊べるクラシック風マイクロMMO、Wildhaven で壮大な冒険に出ましょう。永続的な共有ワールドに参加し、クラスを育て、敵を倒してください。',
  'seo.genre': 'MMORPG',
  ...
  'a11y.githubProject': 'GitHubでWildhavenプロジェクトを開く',
  'a11y.discordCommunity': 'WildhavenのDiscordコミュニティに参加',
  'a11y.donateProject': 'Wildhavenを支援するために寄付',
  'entryGuard.body':
  ...
  'mobilePreflight.iosOpenStep': '新しいホーム画面アイコンからWildhavenを開きます。',
  ...
  'mobilePreflight.androidOpenStep': '新しいアイコンからWildhavenを開きます。',
  ...
  'guide.worldPage.intro': 'Wildhavenは、徒歩で渡っていく、ひと続きの大地です。古い街道は南から北へ、始まりの谷、湿地、山嶺を貫き、その先の窪地と地図の北端の雪国へと登り続けます。その街道からは西へ高位の領邦がひと連なり、東にもうひと連なり開けており、ヴェイルの東岸沖には島が浮かんでいます。高速移動はなく、飛行路も馬車もありません。どの道のりも歩くか騎乗するかで進むので、たどり着くことそのものが冒険の一部です。\n\n大地は時も刻みます。昼夜の周期は、あなたのワールドにいる全員が共有する実際の時計で進むので、空は皆にとって同時に夜明けから正午、そして黄昏と闇へと移り変わり、月は満ち欠けを巡り、地上の光もそれにつれて変わります。ミニマップを囲む文字盤が、時刻を読み取る場所です。',
  ...
  'hudChrome.discord.swag.titleChampion': '称号：Wildmoonのチャンピオン',
  ...
  'hudChrome.nativeUpdate.body':
    'Wildhaven の新しいバージョンが利用可能です。今すぐアップデートして最新の修正と改善を入手しましょう。',
  'hudChrome.nativeUpdate.bodyWithVersion':
    'Wildhaven のバージョン {version} が利用可能です。今すぐアップデートして最新の修正と改善を入手しましょう。',
  ...
  'desktop.crash.fatalBody': 'Wildhaven で予期しないエラーが発生したため、終了します。',
  ...
  'editor.docTitle': 'マップエディター - Wildhaven',
  ...
  'hudChrome.wiki.confirmBody':
    'Wildhaven のWikiをブラウザで開きます。ゲームはそのまま続行されます。',
  ...
  'hudChrome.perf.diagnostics.panelAria': 'Wildhaven パフォーマンス診断',
  'hudChrome.perf.diagnostics.title': 'Wildhaven パフォーマンス診断',
  ...
  'hudChrome.perf.diagnostics.report.title': 'Wildhaven パフォーマンス診断',
