...
export const zh_TW: Partial<Record<TranslationKey, string>> = {
  ...
  'seo.officialLabel': 'Wildhaven 官方網站',
  'seo.officialBody':
    'wildhaven.example 是 Wildmoon 世界的官方免費瀏覽器 MMO。你可以用持久角色線上遊玩，也可以離線單人探索、閱讀 wiki，並從本站前往已驗證的社群連結。',
  ...
  'playerCard.shareText':
    '我正在 Wildhaven 中鑄就傳說：{level}級 {className}{tierBit}。加入我的世界：',
  ...
  'controls.chat': '開啟對話框',
  'seo.title': 'Wildhaven：經典風格網頁 MMO',
  'seo.description':
    '在 Wildhaven 展開史詩冒險。這是一款可直接在瀏覽器中遊玩的經典風格微型 MMO。加入持續共享的世界，提升職業等級並擊敗敵人！',
  'seo.genre': 'MMORPG',
  'seo.playMode': '多人遊戲',
  ...
  'a11y.githubProject': '開啟 Wildhaven 的 GitHub 專案',
  'a11y.discordCommunity': '加入 Wildhaven 的 Discord 社群',
  'a11y.donateProject': '捐贈支持 Wildhaven',
  'entryGuard.body':
  ...
  'mobilePreflight.iosOpenStep': '從新的主畫面圖示開啟 Wildhaven。',
  ...
  'guide.worldPage.intro': 'Wildhaven 是一片你要靠雙腳走遍的連續大陸。古道自南向北穿過起始山谷、沼澤和山峰，並越過它們繼續攀升，通向其後的窪地以及地圖頂端的雪境。自那條路向西展開一列更高等級的國度，向東另有一列，谷地東岸外還有一座島嶼。這裡沒有快速旅行，沒有飛行路線，也沒有馬車：每一段路程都靠步行或騎乘完成，所以抵達本身就是冒險的一部分。\n\n這片大地也記錄著時間。晝夜循環依照一只你所在世界人人共享的真實時鐘運轉，因此天空會為你們所有人同時從黎明經正午走向黃昏與夜色，月亮循著盈虧來去，地面上的光影也隨之變化。小地圖周圍的錶盤，就是你讀取時辰的地方。',
  ...
  'hudChrome.discord.swag.titleChampion': '稱號：Wildmoon 勇士',
  ...
  'desktop.crash.fatalBody': 'Wildhaven 發生未預期的錯誤，必須關閉。',
  ...
  'editor.docTitle': '地圖編輯器 - Wildhaven',
  ...
  'hudChrome.wiki.confirmBody': '將在瀏覽器中開啟 Wildhaven 維基，遊戲會繼續執行。',
  ...
  'hudChrome.perf.diagnostics.panelAria': 'Wildhaven 效能診斷',
  'hudChrome.perf.diagnostics.title': 'Wildhaven 效能醫生',
  ...
  'hudChrome.perf.diagnostics.report.title': 'Wildhaven 效能診斷',
