...
export const pl_PL: Partial<Record<TranslationKey, string>> = {
  ...
  'seo.genre': 'MMORPG',
  'seo.officialBody':
    'wildhaven.example to oficjalne, darmowe przeglądarkowe MMO dla świata Wildmoon. Graj online z trwałą postacią, eksploruj solo w trybie offline, czytaj wiki i śledź zweryfikowane linki społeczności z tej strony.',
  ...
  'serverUnavailable.body':
    'Ponownie uruchamiamy usługę gry i spodziewamy się, że Wildmoon wkrótce wróci. Ta strona będzie automatycznie sprawdzać stan.',
  ...
  'hudChrome.discord.swag.titleChampion': 'Tytuł: Mistrz Wildmoon',
