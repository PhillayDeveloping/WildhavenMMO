...
export const hudChromeStrings = {
  ...
  wiki: {
    ...
    confirmBody: 'This opens the Wildhaven wiki in your browser. The game keeps running.',
  ...
  perf: {
    ...
    diagnostics: {
      panelAria: 'Wildhaven performance diagnostics',
      title: 'Wildhaven Performance Doctor',
      ...
      report: {
        title: 'Wildhaven performance diagnosis',
  ...
  discord: {
    ...
    swag: {
      ...
      titleChampion: 'Title: Champion of Wildmoon',
