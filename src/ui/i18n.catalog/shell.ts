...
export const shellStrings = {
  en: {
    seo: {
      title: 'Wildhaven: Classic-Style Web MMO',
      description:
        'Embark on an epic adventure in Wildhaven, a classic-style micro-MMO playable directly in your browser. Join a persistent shared world, level up classes, and defeat enemies!',
      genre: 'MMORPG',
      playMode: 'Multiplayer',
      applicationCategory: 'Game',
      operatingSystem: 'Web browser',
      officialLabel: 'Official Wildhaven website',
      officialBody:
        'wildhaven.example is the official free browser MMO for the Wildmoon world. Play online with a persistent character, explore solo offline, read the wiki, and follow verified community links from this site.',
    },
    a11y: {
      ...
      githubProject: 'Open the Wildhaven GitHub project',
      discordCommunity: 'Join the Wildhaven Discord community',
      donateProject: 'Donate to support Wildhaven',
    },
    entryGuard: {
    ...
    mobilePreflight: {
      ...
      iosOpenStep: 'Open Wildhaven from the new Home Screen icon.',
      ...
      androidOpenStep: 'Open Wildhaven from the new icon.',
    ...
    serverUnavailable: {
      title: 'Wildhaven - World Unavailable',
      logoAlt: 'Wildhaven',
      eyebrow: 'World maintenance',
      heading: 'The world is temporarily unavailable.',
      body: 'We are restarting the game service and expect Wildmoon to return shortly. This page will keep checking automatically.',
      status: 'Back soon',
    },
  },
  es: {
    seo: {
      ...
      description:
        'Emprende una aventura épica en Wildhaven, un micro-MMO de estilo clásico que se juega directamente en el navegador. Entra a un reino compartido, sube de nivel y derrota enemigos.',
      genre: 'MMORPG',
    ...
    serverUnavailable: {
      title: 'Wildhaven - Reino no disponible',
      logoAlt: 'Wildhaven',
  ...
  es_ES: {
    seo: {
      title: 'Wildhaven: MMO web de estilo clásico',
      description:
        'Emprende una aventura épica en Wildhaven, un micro-MMO de estilo clásico jugable directamente en el navegador. Únete a un reino compartido, sube clases de nivel y derrota enemigos.',
      genre: 'MMORPG',
      playMode: 'Multijugador',
      applicationCategory: 'Juego',
      operatingSystem: 'Navegador web',
    ...
    a11y: {
      ...
      githubProject: 'Abrir el proyecto Wildhaven en GitHub',
      discordCommunity: 'Unirse a la comunidad de Wildhaven en Discord',
      donateProject: 'Donar para apoyar Wildhaven',
    },
    loading: {
  ...
  fr_FR: {
    seo: {
      title: 'Wildhaven: MMO web de style classique',
      description:
        'Partez pour une aventure épique dans Wildhaven, un micro-MMO au style classique jouable directement dans votre navigateur. Rejoignez un royaume persistant, progressez en classe et terrassez vos ennemis.',
      genre: 'MMORPG',
    ...
    a11y: {
      ...
      githubProject: 'Ouvrir le projet Wildhaven sur GitHub',
      discordCommunity: 'Rejoindre la communauté Wildhaven sur Discord',
      donateProject: 'Faire un don pour soutenir Wildhaven',
    },
    loading: {
    ...
    mobilePreflight: {
      ...
      iosOpenStep: "Ouvrez Wildhaven depuis la nouvelle icône de l'écran d'accueil.",
      androidStandaloneDetail:
      ...
      androidOpenStep: 'Ouvrez Wildhaven depuis la nouvelle icône.',
    ...
    serverUnavailable: {
      title: 'Wildhaven - Royaume indisponible',
      logoAlt: 'Wildhaven',
      eyebrow: 'Maintenance du royaume',
      heading: 'Le royaume est temporairement indisponible.',
      body: 'Nous redémarrons le service de jeu et Wildmoon devrait revenir bientôt. Cette page continuera de vérifier automatiquement.',
  ...
  fr_CA: {
    seo: {
      title: 'Wildhaven: MMO Web de style classique',
      description:
        "Partez à l'aventure dans Wildhaven, un micro-MMO de style classique jouable directement dans votre navigateur. Rejoignez un royaume partagé, faites progresser vos classes et terrassez des ennemis.",
      genre: 'MMORPG',
      playMode: 'Multijoueur',
      applicationCategory: 'Jeu',
      operatingSystem: 'Navigateur Web',
    ...
    serverUnavailable: {
      ...
      eyebrow: 'Maintenance du royaume',
      heading: 'Le royaume est temporairement indisponible.',
      body: 'Nous redémarrons le service de jeu et Wildmoon devrait revenir sous peu. Cette page continuera de vérifier automatiquement.',
  ...
  en_CA: {
    seo: {
      title: 'Wildhaven: Classic-Style Web MMO',
      description:
        'Embark on an epic adventure in Wildhaven, a classic-style micro-MMO playable directly in your browser. Join a persistent shared realm, level up classes, and defeat enemies!',
      genre: 'MMORPG',
      playMode: 'Multiplayer',
      applicationCategory: 'Game',
      operatingSystem: 'Web browser',
    ...
    serverUnavailable: {
      title: 'Wildhaven - Realm Unavailable',
      logoAlt: 'Wildhaven',
  ...
  it_IT: {
    seo: {
      title: 'Wildhaven: MMO web in stile classico',
      description:
        "Parti per un'avventura epica in Wildhaven, un micro-MMO in stile classico giocabile direttamente dal browser. Entra in un reame condiviso, fai crescere le classi e sconfiggi i nemici.",
      genre: 'MMORPG',
    ...
    a11y: {
      ...
      githubProject: 'Apri il progetto Wildhaven su GitHub',
      discordCommunity: 'Entra nella community Discord di Wildhaven',
      donateProject: 'Fai una donazione per sostenere Wildhaven',
    },
    loading: {
    ...
    mobilePreflight: {
      ...
      iosOpenStep: 'Apri Wildhaven dalla nuova icona nella schermata Home.',
      androidStandaloneDetail:
      ...
      androidOpenStep: 'Apri Wildhaven dalla nuova icona.',
    ...
    serverUnavailable: {
      title: 'Wildhaven - Reame non disponibile',
      logoAlt: 'Wildhaven',
      eyebrow: 'Manutenzione del reame',
      heading: 'Il reame è temporaneamente non disponibile.',
      body: 'Stiamo riavviando il servizio di gioco e prevediamo che Wildmoon torni a breve. Questa pagina continuerà a controllare automaticamente.',
      status: 'Torna presto',
    },
  },
  de_DE: {
    seo: {
      title: 'Wildhaven: Klassisches Web-MMO',
      description:
        'Begib dich in Wildhaven auf ein episches Abenteuer, ein Micro-MMO im klassischen Stil direkt im Browser. Betritt einen gemeinsamen Realm, steigere Klassen und besiege Gegner.',
      genre: 'MMORPG',
    ...
    a11y: {
      ...
      githubProject: 'Wildhaven-Projekt auf GitHub öffnen',
      discordCommunity: 'Der Wildhaven-Community auf Discord beitreten',
      donateProject: 'Spenden, um Wildhaven zu unterstützen',
    },
    loading: {
    ...
    mobilePreflight: {
      ...
      iosOpenStep: 'Öffne Wildhaven über das neue Symbol auf dem Home-Bildschirm.',
      ...
      androidOpenStep: 'Öffne Wildhaven über das neue Symbol.',
    ...
    serverUnavailable: {
      title: 'Wildhaven - Realm nicht verfügbar',
      logoAlt: 'Wildhaven',
      eyebrow: 'Realmwartung',
      heading: 'Der Realm ist vorübergehend nicht verfügbar.',
      body: 'Wir starten den Spieldienst neu und erwarten, dass Wildmoon bald zurückkehrt. Diese Seite prüft automatisch weiter.',
      status: 'Bald zurück',
    },
  },
  zh_CN: {
    seo: {
      title: 'Wildhaven：经典风格网页 MMO',
      description:
        '在 Wildhaven 展开史诗冒险。这是一款可直接在浏览器中游玩的经典风格微型 MMO。加入持续共享的服务器，提升职业等级，击败敌人。',
      genre: 'MMORPG',
      playMode: '多人游戏',
    ...
    a11y: {
      ...
      githubProject: '打开 Wildhaven 的 GitHub 项目',
      discordCommunity: '加入 Wildhaven 的 Discord 社区',
      donateProject: '捐赠支持 Wildhaven',
    },
    loading: {
      world: '正在加载世界...',
    ...
    mobilePreflight: {
      ...
      iosOpenStep: '从新的主屏幕图标打开 Wildhaven。',
  ...
  zh_TW: {
    seo: {
      ...
      description:
        '在 Wildhaven 展開史詩冒險。這是一款可直接在瀏覽器中遊玩的經典風格微型 MMO。加入持續共享的伺服器，提升職業等級並擊敗敵人。',
      genre: 'MMORPG',
      playMode: '多人遊戲',
    ...
    serverUnavailable: {
      title: 'Wildhaven - 伺服器不可用',
      logoAlt: 'Wildhaven',
      eyebrow: '伺服器維護',
      heading: '伺服器暫時不可用。',
      body: '我們正在重新啟動遊戲服務，Wildmoon 應會很快恢復。此頁面會自動持續檢查。',
      status: '即將恢復',
    },
  },
  ko_KR: {
    seo: {
      ...
      description:
        '브라우저에서 바로 즐기는 클래식 스타일 마이크로 MMO, Wildhaven에서 장대한 모험을 시작하세요. 지속되는 공유 렐름에 접속해 직업을 성장시키고 적을 물리치세요.',
      genre: 'MMORPG',
      playMode: '멀티플레이어',
    ...
    serverUnavailable: {
      title: 'Wildhaven - 렐름 이용 불가',
      logoAlt: 'Wildhaven',
      eyebrow: '렐름 점검',
      heading: '렐름을 일시적으로 이용할 수 없습니다.',
      body: '게임 서비스를 재시작하고 있으며 Wildmoon은 곧 돌아올 예정입니다. 이 페이지는 자동으로 계속 확인합니다.',
      status: '곧 돌아옵니다',
    },
  },
  ja_JP: {
    seo: {
      ...
      description:
        'ブラウザで直接遊べるクラシック風マイクロMMO、Wildhaven で壮大な冒険に出ましょう。永続的な共有レルムに参加し、クラスを育て、敵を倒してください。',
      genre: 'MMORPG',
      playMode: 'マルチプレイヤー',
  ...
  pt_BR: {
    seo: {
      title: 'Wildhaven: MMO web em estilo clássico',
      description:
        'Embarque em uma aventura épica em Wildhaven, um micro-MMO de estilo clássico jogável diretamente no navegador. Entre em um reino compartilhado, evolua classes e derrote inimigos.',
      genre: 'MMORPG',
    ...
    a11y: {
      ...
      githubProject: 'Abrir o projeto Wildhaven no GitHub',
      discordCommunity: 'Entrar na comunidade Wildhaven no Discord',
      donateProject: 'Doar para apoiar Wildhaven',
    },
    loading: {
    ...
    mobilePreflight: {
      ...
      iosOpenStep: 'Abra Wildhaven pelo novo ícone na tela inicial.',
      androidStandaloneDetail:
      ...
      androidOpenStep: 'Abra Wildhaven pelo novo ícone.',
    ...
    serverUnavailable: {
      title: 'Wildhaven - Reino indisponível',
      logoAlt: 'Wildhaven',
      eyebrow: 'Manutenção do reino',
      heading: 'O reino está temporariamente indisponível.',
      body: 'Estamos reiniciando o serviço do jogo e esperamos que Wildmoon volte em breve. Esta página continuará verificando automaticamente.',
  ...
  ru_RU: {
    seo: {
      ...
      description:
        'Отправьтесь в эпическое приключение в Wildhaven, микро-MMO в классическом стиле прямо в браузере. Присоединяйтесь к общему миру, развивайте классы и побеждайте врагов.',
      genre: 'MMORPG',
    ...
    serverUnavailable: {
      ...
      body: 'Мы перезапускаем игровой сервис и ожидаем, что Wildmoon скоро вернется. Эта страница продолжит проверку автоматически.',
