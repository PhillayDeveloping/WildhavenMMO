#!/bin/bash
# Wildhaven — EC2 first-boot setup (cloud-init user data).
#
...
# Admin dashboard domain (e.g. "admin.wildhaven.example"), also with an
...
echo "=== Wildhaven setup finished: $(date -u) ==="
